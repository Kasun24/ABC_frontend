...
import {
  cartItemHeader,
  cartItems,
} from "@/components/dashboard/eCommerce/shopCart/utils";
import NumberSpinner from "@/app/common/components/NumberSpinner.vue";
import { CartItemType } from "@/components/dashboard/eCommerce/shopCart/types";
    ...
    <v-row justify="center">
      <v-col cols="12" lg="10">
        <v-row no-gutters>
          ...
          <v-col cols="12" lg="3">
            <Card title="Order Summary" class="h-100">
              <v-card-text>
                ...
                <v-row justify="space-between">
                  <v-col cols="auto">Estimate Tax (18%): </v-col>
